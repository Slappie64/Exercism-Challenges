...
{
    public string GetDisplayName(TeamSupport support) => support is Staff ? support.Title + (support.GetType() == typeof(Security) ? " Priority Personnel" : "") : "Too Important for a Security Pass";
}
